...
export const TUT = {
  ...
  groundIntro: {
    text: "Touchdown! Now, for some planetside information: we are here to collect ore and leave. But..sometimes..you may encounter some resistance. Pirates are also after resources, and some of the wildlife bite when they get hungry.\nA good rule for extraction: defend FIRST, mine second.",
  ...
  wave: {
    text: "Contacts! Sensors read a pirate party on one flank and some very upset locals on the other.\nHold your ground! Let the turret work, use your gun and grenades, and keep them off the lander!",
    choices: [{ label: 'Hold the line!' }],
  } as DialogueNode,
  waveFight: "Hold your ground! And remember - if things ever get too dire, you can always board the lander and return to orbit.",
  death: {
    text: "Well, you've just died. As you know, Extractors are company property until your debt is forfeit or settled. Remain healthy on the field, kind human.\nYou won't meet your end in this sim.",
    choices: [{ label: '...Thanks, PAT.' }],
  } as DialogueNode,
  waveDone: {
    text: "And that's how it goes out here: something always wants your ore, your lander, or you.\nStay alert, my friend.",
  ...
  medikit: {
    text: "In case you get hurt: you can check your health status on the bottom left. The lander has a MEDIKIT in its cargo - the crate with a green-cross.\nInstant full heal, single use. Use it wisely, the company cannot heal you if you're dead.\nAnd an early death hurts profits.",
    choices: [{ label: "Better to use it only when I'm hurt. Got it." }],
  } as DialogueNode,
  harvest: {
    text: "If you don't want to deploy your Cargo Drone, or in case you lose it, you can return your extractors to the lander to collect the ore. When an extractor's bar is full, hold [E] on it to pack it into a crate, haul it to the lander and press [E] to store it.\nYou cannot shoot when you're holding crates, so press [Q] to drop them if needed!",
  ...
  audits: {
    text: "A final note regarding Profits: once you dock back at the ship, everything you did on the field will be audited. To maximize profits, return your equipment to the lander.\nCorporate understands if you're in a hurry, but abandoned equipment will be billed from your run.",
